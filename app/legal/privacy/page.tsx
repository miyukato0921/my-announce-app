...
<p>本クラウドファンディングサイト（以下「本サービス」）における個人情報の取り扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。本サービスをご利用いただくにあたり、本ポリシーにご同意のうえご利用ください。</p>

<h3>第1条（収集する個人情報）</h3>
<p>本サービスの提供にあたり、以下の個人情報を収集する場合があります。</p>
<ul>
<li>氏名（ニックネームを含む）</li>
<li>メールアドレス</li>
...
<li>決済に関する情報（※クレジットカード番号はStripe, Inc.が管理します）</li>
...
<h3>第3条（第三者への提供）</h3>
<p>以下の場合を除き、ご本人の同意なく個人情報を第三者に提供することはありません。</p>
<ul>
<li>法令に基づく場合</li>
<li>人の生命・身体または財産の保護のために必要な場合</li>
<li>本サービスの運営に必要な範囲での業務委託先への提供</li>
</ul>
...
<h3>第4条（安全管理措置）</h3>
<p>個人情報の漏洩、滅失、毀損を防止するため、以下の安全管理措置を講じます。</p>
<ul>
...
<h3>第8条（本ポリシーの改定）</h3>
<p>法令の変更、社会情勢の変化、またはサービス内容の変更に伴い、本ポリシーを予告なく改定する場合があります。改定後のポリシーは本ページに掲載した時点から効力を生じます。重大な変更がある場合は、本サービス上で別途お知らせいたします。</p>

<h3>第9条（お問い合わせ窓口）</h3>
<p>個人情報の取り扱いに関するお問い合わせ・ご請求は、管理画面の共通設定に記載のメールアドレスまでご連絡ください。</p>
